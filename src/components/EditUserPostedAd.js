...
const handleLocationInputChange = async (event) => {
  ...
  const handleBrandChange = (event) => {
   ...
   // Initialize images state with adDetails.images
  ...
  <div>
    ...
    >
      <span className="text-gray-950">Change Category</span>
    </label>
...
\        {Object.keys(data).map((category) => (
  ...
  <div>
    ...
    >
      <span className="text-gray-950">Change Brand</span>
    </label>
    <div className="relative">
      <select
        id="brand"
  ...
  <div>
    <label
      ...
      className="block text-md font-semibold text-gray-950  mb-2"
    >
      <span className="text-gray-950">Change Model</span>
    </label>
    <div className="relative">
      <select
        id="model"
  ...
  <label
    ...
    className="block text-md font-semibold text-gray-950  mb-2"
  >
    <span className="text-gray-950">Update Mobile Phone Number</span>
  </label>
  <div className="relative">
    <input
      type="tel"
  ...
  <input
    ...
    placeholder={adDetails.location.readable}
  />
